    ...
    if connection:
        try:
            with connection.cursor() as cursor:
                sql = f"SELECT * FROM {geraet} ORDER BY zeitstempel"  # Annahme: 'id' ist die Primärschlüsselspalte
                cursor.execute(sql)
...
for record in last_records:
    ...
    # Direkt den Datensatz zur vorhandenen Liste 'daten_geraet' hinzufügen (hier fügst du den gesamten Datensatz hinzu)
